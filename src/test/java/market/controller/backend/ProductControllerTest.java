...
public class ProductControllerTest {
	...
	public void beforeEach() {
		paginationProperties = FixturesFactory.paginationProperties();
		ProductController controller = new ProductController(productService, distilleryService, paginationProperties);
	...
	public void allProducts() throws Exception {
		PageRequest request = PageRequest.of(0, paginationProperties.getBackendProduct());
		...
		mockMvc.perform(get("/admin/products"))
			...
			.andExpect(model().attribute("page",
				allOf(
					...
					hasProperty("content", containsInRelativeOrder(productDtoAssembler.toDtoArray(page.getContent())))
				)
			))
	...
	public void editProduct() throws Exception {
		...
		mockMvc.perform(get("/admin/products/" + product1.getId() + "/edit"))
			.andExpect(status().isOk())
	...
	public void putProduct() throws Exception {
		...
		mockMvc.perform(
			post("/admin/products/" + product1.getId() + "/edit")
				.param("distillery", distillery.getTitle())
	...
	public void deleteProduct() throws Exception {
		mockMvc.perform(post("/admin/products/" + product1.getId() + "/delete"))
			.andExpect(status().is3xxRedirection())
			.andExpect(redirectedUrl("/admin/products"));
